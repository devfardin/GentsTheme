...
<body <?php body_class(); ?>>
        ...
        <div class="header-container container">
            ...
            <div class="header-search">
                <form class="search-form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    <input type="text" class="search-input" placeholder="Search for products..." name="s"
                        autocomplete="off">
            ...
            <div class="header-icons">
                ...
                <!-- Cart -->
                <a class="header-icon-btn cart-toggle-btn" aria-label="Shopping cart" id="cart-sidebar-toggle">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                ...
                <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer"
                    class="header-icon-btn whatsapp-btn" aria-label="WhatsApp">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                ...
                <a href="<?php echo function_exists('wc_get_account_endpoint_url') ? esc_url(wc_get_account_endpoint_url('dashboard')) : wp_login_url(); ?>"
                    class="header-icon-btn" aria-label="My account">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
    ...
    <div class="offcanvas-panel" id="offcanvas-menu" role="dialog" aria-modal="true" aria-label="Navigation menu">
        ...
        <div class="offcanvas-search">
            <form class="search-form offcanvas-search-form" role="search" method="get"
                action="<?php echo esc_url(home_url('/')); ?>">

                <input type="text" class="search-input offcanvas-search-input" placeholder="Search for products..."
    ...
    <!-- =============================================
         ...
         ============================================= -->
    <div class="cart-sidebar-overlay" id="cart-sidebar-overlay" aria-hidden="true"></div>
    <div class="cart-sidebar" id="cart-sidebar" role="dialog" aria-modal="true" aria-label="Shopping cart">
        <div class="cart-sidebar-header">
            <span class="cart-sidebar-title">Your Cart</span>
            <button class="cart-sidebar-close" id="cart-sidebar-close" aria-label="Close cart">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 30 30">
                    <path d="M14.9996 13.2331L21.1869 7.0459L22.9546 8.81366L16.7674 15.0009L22.9546 21.188L21.1869 22.9557L14.9996 16.7686L8.81245 22.9557L7.04468 21.188L13.2319 15.0009L7.04468 8.81366L8.81245 7.0459L14.9996 13.2331Z" fill="#00A486" />
                </svg>
            </button>
        </div>
